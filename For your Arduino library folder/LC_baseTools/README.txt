...
Stack objects force the issue that they own the objects they contain. So you create the objects and when you "pop" them off the stack the stack will delete them for you.
...
When you create a class that you would like to run in the background, inherit from idler and it will.
